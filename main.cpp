...
int main()
{
    ...
    // First time startup & settings retrieval
    ...
    // Obtaining the words randomly then printing them
    ...
    printf("Enter anything to shut down the program...\n");
    string exit = "";
    getline(cin, exit);
